...
function PaymentResultContent() {
  ...
  useEffect(() => {
    ...
    const message = searchParams.get('message') || 'Payment status unknown';
              ...
              {resultData.status === 'pending' && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-yellow-800 text-sm">
                    <strong>Note:</strong> Your payment is being processed. You will receive a confirmation once the payment is completed. This may take a few minutes.
                  </p>
                </div>
              )}
              ...
              {resultData.status === 'failed' && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <p className="text-red-800 text-sm">
                    <strong>Payment Failed:</strong> Your payment could not be processed. Please try again or contact support if the issue persists.
                  </p>
                </div>
              )}
              ...
              {resultData.status === 'expired' && (
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                  <p className="text-orange-800 text-sm">
                    <strong>Payment Expired:</strong> The payment session has expired. Please create a new contribution to make a payment.
                  </p>
                </div>
              )}
            </CardContent>
