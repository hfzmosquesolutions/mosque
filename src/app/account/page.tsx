...
function AccountPageContent() {
  ...
  const [user, setUser] = useState({
    id: authUser?.id || '1',
    name: profile?.full_name || 'Ahmad Ibrahim',
    email: authUser?.email || 'ahmad.ibrahim@email.com',
    phone: profile?.phone || '+60123456789',
    role: profile?.role || 'member',
    membershipId: 'MSJ001',
    joinDate: '2020-01-15',
    mosqueName: 'Masjid Al-Hidayah', // Will be populated when mosque data is integrated
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        {isEditing && (
          <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
            ...
            <Button onClick={handleSaveAccount} className="order-1 sm:order-2">
