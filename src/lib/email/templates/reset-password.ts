  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="security-note">
        <p><strong>Security Note:</strong> This password reset link will expire in 1 hour for your security. This request was initiated from your account settings. Your password remains secure unless you complete the reset process.</p>
      </div>
      
      <div class="message">
          <p>Account security recommendations:</p>
          <ul style="color: #475569; padding-left: 20px;">
            <li>Use a strong, unique password</li>
            <li>Keep your password confidential</li>
            <li>Password managers help maintain security</li>
